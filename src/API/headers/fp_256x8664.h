...
static INLINE void fp_cpy_256_ehuff(uni zn, uni an){
#ifdef COUNT_OPERATIONS
	COUNT_ADD++;
#endif
	__asm__ VOLATILE (
...
static INLINE void fp_set_1_256_ehuff(uni zn, uni_t a){
#ifdef COUNT_OPERATIONS
	COUNT_ADD++;
#endif
	__asm__ VOLATILE (
...
static INLINE void fp_add_1_256_ehuff(uni zn, uni an, uni_t b){
#ifdef COUNT_OPERATIONS
	COUNT_ADD++;
#endif
	__asm__ VOLATILE (
...
// static INLINE void fp_sub_1_256_ehuff(uni zn, uni an, uni_t b){
// #ifdef COUNT_OPERATIONS
// 	COUNT_ADD++;
// #endif
// 	__asm__(
...
static INLINE void fp_sub_2_256_ehuff(uni zn, uni_t a, uni bn){
#ifdef COUNT_OPERATIONS
	COUNT_ADD++;
#endif
	__asm__(
...
static INLINE void fp_add_256_ehuff(uni zn, uni an, uni bn){
#ifdef COUNT_OPERATIONS
	COUNT_ADD++;
#endif
	__asm__ VOLATILE (
...
static INLINE void fp_sub_256_ehuff(uni zn, uni an, uni bn){
#ifdef COUNT_OPERATIONS
	COUNT_ADD++;
#endif
	__asm__(
...
static INLINE void fp_mul_256_ehuff(uni zn, uni an, uni bn){
#ifdef COUNT_OPERATIONS
	COUNT_MUL++;
#endif
	__asm__ VOLATILE (
...
// static INLINE void fp_sqr_256_ehuff(uni zn, uni an){
// #ifdef COUNT_OPERATIONS
// 	COUNT_SQR++;
// #endif
// 	__asm__ VOLATILE (
